...
#define V_BUS_MAX			48.0f			// max drive voltage (faults above this)

/* Current controller */
#define L_D .00002f				// D axis inductance
#define L_Q .00002f				// Q axis inductance
...
#define DRV_CS_HIGH HAL_GPIO_WritePin(DRV_CS, GPIO_PIN_SET)
#define DRV_CS_LOW HAL_GPIO_WritePin(DRV_CS, GPIO_PIN_RESET)
#define GPIO_ENABLE HAL_GPIO_WritePin(ENABLE_PIN, GPIO_PIN_SET)
#define GPIO_DISABLE HAL_GPIO_WritePin(ENABLE_PIN, GPIO_PIN_RESET)
#define LED_HIGH HAL_GPIO_WritePin(LED, GPIO_PIN_SET)
#define LED_LOW HAL_GPIO_WritePin(LED, GPIO_PIN_RESET)
#define ENC_CS_HIGH HAL_GPIO_WritePin(ENC_CS, GPIO_PIN_SET)
#define ENC_CS_LOW HAL_GPIO_WritePin(ENC_CS, GPIO_PIN_RESET)
